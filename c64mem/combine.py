...
print('')
print('body {')
print('    background: var(--main-background);')
...
print('}')
print('')
print('th.decimal_column {')
print('    position: absolute;')
print('    width: ' + str(decimal_width) + 'em;')
print('    left: ' + str(address_width + label_width + 3.9) + 'em;')
print('    z-index: 12;')
print('    border: 1px solid #000;')
print('    border-radius: 2px;')
print('    color: var(--main-background);')
...
print('    font-size: 17px;')
print('}')
print('')
print('.topnav h1 {')
print('    color: e0f0ff;')
print('    text-shadow: 0px 1px var(--main-color);')
print('}')
print('')
print('.topnav a:hover {')
print('    background-color: var(--main-background);')
print('    color: black;')
print('}')
print('')
print('.topnav a.active {')
print('    background-color: var(--main-color);')
print('    color: white;')
print('}')
print('details {')
...
print('    <h1>Ultimate Commodore 64:</h1> ')
print('    <a href="../c64disasm/index.html">ROM Disassembly</a><!-- c64disasm/index.html -->')
print('    <a class="active" href="../c64mem/index.html">Memory Map</a><!-- c64mem/index.html -->')
