...
print('        }')
print('        var key = "column_label";')
print('        var element_name = "checkbox_label";')
print('        var visible = localStorage.getItem(key) != "hidden";')
print('        document.getElementById(element_name).checked = visible;')
print('        toggleLabel(visible);')
print('    }')
print('    function toggleLabel(visible) {')
print('        var tbl = document.getElementById("disassembly_table");')
print('        for (var i = 0; i < tbl.rows.length; i++) {')
print('            tbl.rows[i].cells[1].style.display = visible ? "" : "none";')
print('        }')
print('        var key = "column_label";')
print('        var cnt = document.getElementById("disassembly_container");')
print('        if (visible) {')
print('            cnt.className = "disassembly_container_with_label";')
print('            localStorage.removeItem(key);')
print('        } else {')
print('            cnt.className = "disassembly_container_no_label";')
...
print('        var tbl = document.getElementById("disassembly_table");')
print('        for (var i = 0; i < tbl.rows.length; i++) {')
print('            tbl.rows[i].cells[col+2].style.display = checked ? "" : "none";')
print('        }')
...
print('}')
print('')
print('div.disassembly_container_with_label {')
print('    padding: 1em 0em 1em 11.4em;')
print('    overflow: scroll;')
print('}')
print('div.disassembly_container_no_label {')
print('    padding: 1em 0em 1em 7.4em;')
print('    overflow: scroll;')
print('}')
print('')
print('table {')
...
for i in range(0, len(filenames)):
	print('table.disassembly_table th.top_row:nth-of-type(' + str(i+3) + ') {')
...
print('<p><input type="checkbox" id="checkbox_label" name="checkbox_label" checked onclick="toggleLabel(document.getElementById(\'checkbox_label\').checked);">')
print('<label for="checkbox_label">Show Symbol</label></input></p>')

print('<div class="disassembly_container_with_label" id="disassembly_container">')
