...
for i in range(0, len(filenames)):
	print('table.disassembly_table th.top_row:nth-of-type(' + str(i + 1 + offset) + ') {')
...
print('<p><input type="checkbox" id="checkbox_decimal" name="checkbox_decimal" onclick="toggleDecimal(document.getElementById(\'checkbox_decimal\').checked);">')
print('<label for="checkbox_decimal">Show Decimal Address</label></input></p>')
